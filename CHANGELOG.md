...
- **Wiring:** AGENTS.md "Workflow and doc optimization" expanded with skill-optimizer, llm-docs-optimizer, manage-markdown-docs, modern-tool-substitution, hooks-configuration, ref-toon-format/use-toon, validate-toon. skills-guide.md, skills-ref.md, tools-reference.md, toon.md, and hooks.md updated with in-repo pointers and CLAUDE_PLUGIN_ROOT notes.

### Changed

- **Marketplace:** Removed technical-writer and data-analyst from [.claude-plugin/marketplace.json](.claude-plugin/marketplace.json) (plugins not present in repo). SETUP.md and README install examples use only existing plugins.
