...
Guidelines for creating skills following the Agent Skills open standard (agentskills.io).

## YAML Frontmatter Schema

Skills in this repo follow the Agent Skills standard with optional extensions.

### Standard Fields (agentskills.io)

Required fields:
- name: Skill identifier, lowercase with hyphens, max 64 characters (e.g. {category}-{name})
...
- Conditional: AskUserQuestion (orchestrator only), Task (specialist agents)
...
- Mark extension fields with standardized comments
