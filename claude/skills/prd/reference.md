...
```json
{
  ...
  "testing": {
    "types": ["unit", "e2e"],
    "files": { "unit": ["src/components/Dashboard.test.tsx"], "e2e": ["tests/e2e/dashboard.spec.ts"] }
  },
  "testSteps": [
    "npx tsc --noEmit",
...
```json
{
  ...
  "testing": {
    "types": ["unit", "integration"],
    "files": { "unit": ["tests/unit/test_users.py"], "integration": ["tests/integration/test_users_api.py"] }
  },
  "testSteps": [
